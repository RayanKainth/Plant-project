  ...
  return (
    <>
        ...
        <div className="max-w-[600px] pt-[20px]">
          <p className=" text-[20px] font-light">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        ...
        <div className="flex gap-2 pt-[20px]">
          ...
          <button className="text-[#1D6148] px-8 py-2 rounded-[10px] border border-green-600">Learn more</button>
        </div>
                </div>
              </div>
    </div>
